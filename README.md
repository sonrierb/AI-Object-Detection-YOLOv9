# AI-Object-Detection-YOLOv9 (YOLOv9 + FastAPI + Streamlit)
Real-time object detection system built using YOLOv9, integrated with FastAPI, Streamlit, and OpenCV, supporting image detection, video detection, webcam inference, and a desktop video viewer.

## Features

✔ Real-time object detection (YOLOv9)
✔ Image upload + detection API
✔ Video upload + background processing with progress tracking
✔ Streamlit web UI for detection
✔ Webcam live detection script
✔ Desktop video result viewer
...
│   ├── utils.py               # Utilities for detection, saving, encoding
│   ├── outputs/               # Saved detected images & videos
│   ├── app.py                 # Streamlit UI
│   ├── desktop_viewer.py      # Desktop CV2-based video viewer
│   └── webcam.py              # Webcam live detection
│
├── requirements.txt
└── README.md
